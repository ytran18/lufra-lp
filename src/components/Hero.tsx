...
export default function Hero() {
  return (
    <section className="relative min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-transparent z-10 px-6 max-w-[1400px] mx-auto pt-24 lg:pt-0">
      ...
      <div className="flex flex-col items-start text-left lg:pl-12 lg:pr-4 order-2 lg:order-1 pt-10 lg:pt-0 pb-[10vh]">
        
        {/* Headline */}
        <h1 className="text-6xl md:text-8xl font-bold text-black tracking-tighter leading-[0.95] mb-6">
          Multitask.
          <br /> Without limits.
        </h1>

        {/* Sub-headline */}
        <p className="max-w-xl text-xl md:text-2xl text-[#86868b] leading-relaxed mb-10 tracking-tight">
      ...
      <div className="w-full h-[60vh] lg:h-screen order-1 lg:order-2 flex items-center justify-center relative">
        {/* Absolute fill for the canvas to break out of grid alignment styling if needed, but flex center keeps it bounded */}
